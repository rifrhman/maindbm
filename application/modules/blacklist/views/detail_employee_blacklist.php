...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm">
          <h1>Detail Karyawan Blacklist</h1>
        </div>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-lg-12">
          <div class="card card-danger">
            <div class="card-header">
              <h3 class="card-title font-weight-bold">Data Blacklist Karyawan</h3>
              <div class="card-tools">
                <button type="button" class="btn btn-tool" data-card-widget="collapse">
                  <i class="fas fa-minus"></i>
                </button>
              ...
              <div class="card card-default">
                ...
                <div class="card-body">
                  ...
                  <div class="row col-lg-12">
                    ...
                    <div class="form-group col-md-5">
                      <label for="institute">Tanggal Blacklist</label>
                      <input type="text" class="form-control" id="date_resign" value="<?= $res['date_resign'] ?>"
                        readonly>
                    </div>
                    <div class="form-group col-md-4">
                      <label for="major">Keterangan Blacklist</label>
