...
class Dropout_model extends CI_Model
{
  ...
  public function quer()
  {
    ...
    LEFT JOIN resign_employee ON resign_employee.basic_id = candidate_basic.id_candidate
    WHERE send_candidate.confirm = 'Approved' AND send_candidate.confirm_admin = 'Approved'
    AND pkwt_employee.flags_resign = 'Resign' AND send_candidate.is_join = 'Join'
